...
public class HeadPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageSurfaceView = new ImageSurfaceView(HeadPhotoActivity.this, camera);
    ...
    private void saveImageToExternalStorage(Bitmap finalBitmap) {
        ...
        File myDir = new File(root + "/DressMeApp/Head");
        myDir.mkdirs();
    ...
    Camera.PictureCallback pictureCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (bitmap == null) {
                Toast.makeText(HeadPhotoActivity.this, "Captured image is empty", Toast.LENGTH_LONG).show();
                return;
            }
